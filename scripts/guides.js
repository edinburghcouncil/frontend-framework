$(function() {
    ...
    var toggleAnchor = $('<a href="javascript:void(0)" class="menu-link icon-down-open-mini">'+hiddenText+'</a>');
...
$(function(){
    $(".jsPrevNextContainer").append(
        '<a href="javascript:void(0)" class="jsNavigateToPrevTab prev-tab icon-left-open-mini">Prev</a>\n'+
        '<a href="javascript:void(0)" class="jsNavigateToNextTab next-tab icon-right-open-mini after">Next</a>'
    );
});
...
$(function() {    
    ...
    function setActiveTab(tabId){
        ...
        function activateGuideAnchor(tabId) {
            ...
            $("ol.guide-steps li a span.away").remove();
